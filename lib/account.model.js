 ...
 * @instance
 */
AccountSchema.methods.removeAccessor = function removeAccessor(phone, done) {

  //TODO specs

  //obtain unique accessors
  let accessors = [].concat(this.ensureUniqueAccessors());
...
AccountSchema.methods.afterPost = function afterPost(done) {
  //TODO in background
  //1...update account from sync endpoint
