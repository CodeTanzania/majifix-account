...
//TODO add support to (contactee or reporter) that can use the accoount
...
AccountSchema.methods.beforePost = function beforePost(done) {
  ...
  //continue
    ...
    //TODO implement Account#locate():Point
    done();
  }
};
...
/**
 * @name beforePut
 * @description pre putaccount logics
 * @param  {Function} done callback to invoke on success or error
 */
...
AccountSchema.statics.MODEL_NAME = MODEL_NAME;
...
module.exports = mongoose.model(MODEL_NAME, AccountSchema);