 ...
 * @apiSuccess {String} [bills.currency] Human readable bill currency code(i.e USD, TZS etc)
 ...
 * @apiSuccess {Date} [data.bills.items.time] Date when a bill item realized.
 * @apiSuccess {String} [data.bills.currency] Human readable bill currency code(i.e USD, TZS etc)
 ...
 * @apiGroup Account
 *
 * @apiDescription Get account accessor
 ...
 * @apiGroup Account
 *
 * @apiDescription Create account accessor
 * @apiUse AccountRequestHeader
 * @apiUse Account
 * @apiUse AccountRequestHeaderExample
 * @apiUse AccountSuccessResponse
 ...
 * @apiGroup Account
 *
 * @apiDescription Patch account accessor
 * @apiUse AccountRequestHeader
 * @apiUse Account
 * @apiUse AccountRequestHeaderExample
 * @apiUse AccountSuccessResponse
 ...
 * @apiGroup Account
 *
 * @apiDescription Put account accessor
 * @apiUse AccountRequestHeader
 * @apiUse Account
 * @apiUse AccountRequestHeaderExample
 * @apiUse AccountSuccessResponse
 ...
 * @apiGroup Account
 *
 * @apiDescription Delete account accessor
 * @apiUse AccountRequestHeader
 * @apiUse Account
 * @apiUse AccountRequestHeaderExample
 * @apiUse AccountSuccessResponse
  ...
  function removeAccountAccountAccessors(request, response, next) {
    ...
    async.waterfall([
      ...
      function removeAccessors(account, next) {
        account.removeAccessor(phone, next);
      }
